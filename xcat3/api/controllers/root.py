...
from xcat3.api.controllers import v1
...
class Root(base.APIBase):
    ...
    def convert():
        root = Root()
        root.name = "xCAT3 API"
        root.description = ("xCAT is a toolkit for the deployment and "
...
class RootController(rest.RestController):
    ...
    def _route(self, args):
        ...
        It redirects the request to the default version of the xcat3 API
