...
"""XCAT3 common internal object model"""
...
class XCAT3ObjectRegistry(object_base.VersionedObjectRegistry):
    def registration_hook(self, cls, index):
        # NOTE(jroll): blatantly stolen from nova
        # NOTE(danms): This is called when an object is registered,
        # and is responsible for maintaining xcat3.objects.$OBJECT
...
class XCAT3Object(object_base.VersionedObject):
    ...
    OBJ_SERIAL_NAMESPACE = 'xcat3_object'
    OBJ_PROJECT_NAMESPACE = 'xcat3'
    ...
    def obj_refresh(self, loaded_object):
        """Applies updates for objects that inherit from base.XCAT3Object.
...
class XCAT3ObjectSerializer(object_base.VersionedObjectSerializer):
    # Base class to use for object hydration
    OBJ_BASE_CLASS = XCAT3Object
