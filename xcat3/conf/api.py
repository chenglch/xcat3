...
opts = [
    ...
    cfg.PortOpt('port',
                default=3010,
                help=_('The TCP port on which xcat3-api listens.')),
    ...
    cfg.IntOpt('timeout',
               default=3600,
               help=_('The maximum time to wait for the rpc worker.')),
    cfg.StrOpt('public_endpoint',
               help=_("Public URL to use when building the links to the API "
                      "resources (for example, \"https://xcat3.rocks:6384\")."
...
opt_group = cfg.OptGroup(name='api',
                         title='Options for the xcat3-api service')
